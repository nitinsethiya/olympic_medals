...
* [`src/olympic/`](src/olympic/): SPA source files (ClojureScript,
[re-frame](https://github.com/Day8/re-frame))
  - [`core.cljs`](src/olympic/core.cljs): contains the SPA entry point, `init`
...
The `debug?` variable in [`config.cljs`](src/cljs/olympic/config.cljs) defaults to `true` in
...
```clj
(ns olympic.example
  (:require [olympic.config :as config])
